...
const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  ...
  "human-resource-services": {
    ...
    related: {
      ...
      slugs: ["transportation-service", "uniform-services", "civil-engineering-infrastructure"],
    },
    cta: {
  ...
  "financial-consultancy": {
    ...
    capabilities: {
      ...
      items: [
        { title: "FP&A", description: "Budgeting • Forecasting • Financial Modelling" },
        { title: "Accounting & Reporting", description: "Bookkeeping • Ledgers • Financial Statements" },
        { title: "Cash & Treasury", description: "Cash Flow • Liquidity • Banking" },
        { title: "Risk & Compliance", description: "Risk Assessment • Controls • Regulatory Compliance" },
        { title: "Internal Audit", description: "Controls Review • Process Audit • Gap Identification" },
        ...
        { title: "Business Advisory", description: "Strategy • Financial Insights • Decision Support" },
        { title: "Business Setup", description: "Startup Costing • Capital Requirements • Financial Feasibility" },
        { title: "Market & Scenario Planning", description: "Feasibility • Risk Modelling • Expansion Planning" },
        { title: "Banking Support", description: "KYC • Corporate Account Opening • Documentation" },
  ...
  "transportation-service": {
    ...
    related: {
      heading: "Explore Connected Solutions",
      slugs: ["civil-engineering-infrastructure", "uniform-services", "human-resource-services"],
    },
    cta: {
  ...
  "canteen-management-services": {
    ...
    related: {
      heading: "Explore Connected Solutions",
      slugs: ["transportation-service", "uniform-services", "human-resource-services"],
    },
    cta: {
  ...
  "administration-service": {
    slug: "administration-service",
    title: "Administration Service",
    metaTitle: "Administration Service",
    metaDescription:
      "Comprehensive administration and operational support services tailored for educational institutions and businesses, ensuring smooth and efficient daily operations.",
    heroImage: "/Service-page/Transportation-&-Fleet-Support.png",
    cardImage: "/Service-page/Transportation-&-Fleet-Support.png",
    hero: {
      tagline: "Streamlining Operations For Efficiency",
      supportingCopy:
        "We provide comprehensive administration and operational support services, ensuring smooth and efficient daily operations so you can focus on your core mission.",
      ctas: [CONSULTATION_CTA],
    },
    overview: {
    ...
    capabilities: {
      ...
      items: [
        { title: "Operational Support", description: "Daily Operations • Workflow Optimization" },
        { title: "Facility Management", description: "Maintenance • Safety • Security" },
        { title: "Administrative Staffing", description: "Reception • Support Staff • Office Management" },
        { title: "Record Management", description: "Data Entry • Archiving • Compliance" },
        { title: "Vendor Coordination", description: "Procurement • Contracts • Service Level Agreements" },
        { title: "Event Management", description: "Planning • Logistics • Coordination" },
      ],
    },
    whyItMatters: {
      heading: "Why Efficient Administration Matters",
      items: [
        { title: "Focus on Core Mission", description: "Free up leadership time by delegating operational tasks." },
        { title: "Improved Efficiency", description: "Streamlined workflows reduce bottlenecks and delays." },
        { title: "Cost Optimization", description: "Better resource management and vendor coordination." },
        { title: "Enhanced Professionalism", description: "Smooth operations create a better experience for all stakeholders." },
        { title: "Compliance & Safety", description: "Ensure facilities and records meet regulatory standards." },
        { title: "Scalability", description: "Build operational foundations that support future growth." },
      ],
    },
    approach: {
      heading: "Our Administration Approach",
      steps: [
        { number: "01", title: "Analyze", description: "Assess current administrative workflows and facility needs." },
        { number: "02", title: "Streamline", description: "Design optimized processes and allocate the right resources." },
        { number: "03", title: "Execute", description: "Implement solutions with trained personnel and clear guidelines." },
        { number: "04", title: "Monitor", description: "Continuously review performance and adjust for maximum efficiency." },
      ],
    },
    whyChoose: {
      heading: "Expertise You Can Trust",
    ...
    related: {
      heading: "Explore Connected Solutions",
      slugs: ["human-resource-services", "transportation-service", "canteen-management-services"],
    },
    cta: {
      heading: "Let's Optimize Your Operations",
      description: "Partner with administration experts to streamline your daily workflows.",
      ctas: [CONSULTATION_CTA, CONTACT_CTA],
    },
  },
};
